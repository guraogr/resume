        ...
        >
          ...
          <Box ta={isTabletScreen ? 'center' : 'left'}>
            ...
            <CustomText mb={spacing[3]} ta={'left'} sx={{ lineHeight: 2 }}>
              ...
              <br />
              ・複雑なドメインのデザインを行った経験 (GovTech, ConTech等)
              <br />
              ・フロントエンドチームにてReact
              +TypeScriptを用いたUI実装を行った経験
              <br />
              ・大規模プロダクトのデザインシステムや、デザインガイドライン作成に関わった経験
              <br />
              <br />
              ② スタートアップでの勤務経験
              <br />
              ・1人目デザイナーとして、新規事業の立ち上げに関わった経験
              <br />
              ・Webデザイン, UI/UX, バナー, サイト実装など幅広い制作経験
              <br />
            </CustomText>
            {/* <Box
              component="a"
